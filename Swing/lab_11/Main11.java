...
public class Main11 extends JFrame implements Runnable {
    // panel sterowania
    ...
    // przycisk
    private JButton bDraw, bClose, bClear;
    // wybór
    private JComboBox<String> cbShapes;

    public Main11(String title) {
        // tytuł okna
        super(title);
        // rozmiar okna
        setSize(800, 600);
        ...
        controlPanel.add(bClear);
        // obsługa przycisku bClear
        // WYRAŻENIE LAMBDA
        bClear.addActionListener(akuku -> drawPanel.clearShapes());
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Main11("Okno glowne"));
    }
